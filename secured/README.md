# secured — Pulumi GCP Workstations

This setup provisions a Google Cloud Workstations cluster with secured networking and IAM.
...
Workstations cluster, and a secured workstation config in `us-central1`.
